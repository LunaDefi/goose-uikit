...
var Icon$w = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/egg/10.png" })));
};
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/luna_finance",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/Luna_Finance",
    },
];
var MENU_HEIGHT = 64;
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; var cakePriceUsd = _a.cakePriceUsd, lunaPriceUsd = _a.lunaPriceUsd; _a.currentLang; _a.langs; _a.setLang; var priceLink = _a.priceLink;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            lunaPriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
                React__default['default'].createElement(Icon$s, { width: "24px", mr: "8px" }),
                React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + lunaPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })),
        ...
        React__default['default'].createElement(SettingsEntry, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
...
/*
      ...
      <a href="https://rugdoc.io/project/luna-finance/">
        <Image src="https://rugdoc.io/assets/2021/05/rugdoc-review-badge-for-dark-bg.png" width={370} height={121} responsive alt="rugdoctor" />
      </a>
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, lunaPriceUsd = _a.lunaPriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, lunaPriceUsd: lunaPriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#00C3FF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#24A2FA", tertiary: "#353547", text: "#06F9F9", textDisabled: "#666171", textSubtle: "#06F9F9", borderColor: "#524B63", card: "#27262c", gradients: {
