...
var Icon$w = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/egg/10.png" })));
};
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            lunaPriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                React.createElement(Icon$s, { width: "24px", mr: "8px" }),
                React.createElement(Text, { color: "textSubtle", bold: true }, "$" + lunaPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
        ...
        React.createElement(SettingsEntry, null, cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, lunaPriceUsd: lunaPriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
